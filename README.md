...
My solutions to the 2020 Data Structures (CSE2010) assignments at Hanyang University.  
They may contain errors.  

## Assignment 1
Implement polynomial and its addition, multiplication using linked list.  
Read two polynomials(They are discriminated by a blank line) from input file, and print addition/multiplication result to output file.  
Polynomial format: A polynomial is described by several lines. Each line has two numbers. First one is coefficient and second one is degree.  
